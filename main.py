...
from tor.create_ronion import create_ronion, deactivate_expired_onions
...
if __name__ == '__main__':
    if os.environ.get('WERKZEUG_RUN_MAIN') == 'true':
        init_db()
        # threading.Thread(target=countdown_half_rotator_once, args=(fdsfshhhh,), daemon=True).start()
